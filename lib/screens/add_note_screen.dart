  ...
  _submit() {
    if (_formKey.currentState!.validate()) {
      ...
      reference.collection('Tasks').doc(auth.currentUser!.email).get().then((value) {
        ...
        newTasks = value.data()!['tasks'];
        newTasksAnswer = value.data()!['isDone'];
        newTasks.add(myController.text);
        newTasksAnswer.add(false);

        reference.collection('Tasks').doc(auth.currentUser!.email).set({'tasks':newTasks , 'isDone':newTasksAnswer});
